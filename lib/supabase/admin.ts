 ...
 * server-only modules: invite redemption, admin RPC calls (grant_credits,
 * revoke invite, etc.), and anything else that must act outside the
 * calling user's own row. Never expose SUPABASE_SERVICE_ROLE_KEY to the
