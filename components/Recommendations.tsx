...
const PRIORITY_CONFIG = {
  high: { cls: "text-[var(--danger)]", bg: "rgba(255,90,90,0.1)", label: "HIGH" },
  medium: { cls: "text-[var(--warning)]", bg: "rgba(255,184,48,0.1)", label: "MEDIUM" },
  low: { cls: "text-[var(--success)]", bg: "rgba(0,232,122,0.1)", label: "LOW" },
};
