...
async function exportDocx(report: AnalysisResult) {
  ...
  children.push(
    new Paragraph({
      children: [new TextRun({ text: "AI Scope Report", bold: true, size: 52, color: "1a1a2e" })],
  ...
  children.push(
    new Paragraph({
      ...
      children: [new TextRun({ text: `Generated by AI Scope by Marcstrat  ·  ${new Date().toLocaleDateString()}`, size: 18, color: "aaaaaa" })],
    })
  );
