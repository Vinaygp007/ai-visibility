        ...
        >
          ...
          <div className="px-8 py-6 space-y-8 max-h-[70vh] overflow-y-auto">
            ...
            {report.keywords && report.keywords.length > 0 && (
              <div className="rounded-2xl border p-5" style={{ background: "var(--surface)", borderColor: "rgba(var(--overlay-rgb),0.07)" }}>
            ...
            <SpeedSection url={report.url} autoRun />

            {/* Technical Crawl */}
            <CrawlSection url={report.url} autoRun />
