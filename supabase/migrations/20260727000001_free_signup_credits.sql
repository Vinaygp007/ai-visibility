-- Lower the free signup grant from 50 to 20 credits. Re-defines
-- handle_new_user and redeem_invite (last defined in
-- 20260709000004_referrals.sql) with the new signup_grant amount; invite
-- and referral grants are unchanged.
