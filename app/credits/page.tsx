  ...
  return (
    <div className="min-h-screen md:pl-64" style={{ background: "#0a0b10" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-8 pt-16 md:pt-12 pb-12">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Credit History</h1>
        ...
        <div className="rounded-2xl border p-6" style={{ background: "rgba(255,255,255,0.02)", borderColor: "rgba(255,255,255,0.07)" }}>
          {loading ? (
            <p className="text-sm" style={{ color: "#8b8d9e" }}>Loading...</p>
          ) : !data?.entries || data.entries.length === 0 ? (
            <p className="text-sm" style={{ color: "#8b8d9e" }}>No credit activity yet.</p>
          ) : (
            <>
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs mt-0.5" style={{ color: "#8b8d9e" }}>
                      ...
                      <div className="text-right">
                        <span
                          ...
                          style={{
                            ...
                            color: positive ? "#00e87a" : "#ff5858",
                          }}
                        >
                          {positive ? `+${e.amount}` : e.amount}
                        </span>
                        <div className="text-[11px] mt-1" style={{ color: "#6f7280" }}>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between mt-5 pt-4 border-t" style={{ borderColor: "rgba(255,255,255,0.07)" }}>
                  <button
                    onClick={() => setPage((p) => Math.max(0, p - 1))}
                    disabled={page === 0}
                    className="px-4 py-2 rounded-lg text-xs font-medium disabled:opacity-40"
                    style={{ background: "rgba(255,255,255,0.04)", color: "#8b8d9e", border: "1px solid rgba(255,255,255,0.08)" }}
                  >
                    Previous
                  </button>
