              ...
              <div className="flex flex-col items-center mb-6">
                <div className="relative w-20 h-20 mb-3"
                  ...
                  <svg className="absolute inset-0" width="80" height="80" viewBox="0 0 80 80">
                    <circle cx="40" cy="40" r="34" fill="none" stroke="rgba(var(--overlay-rgb),0.06)" strokeWidth="5" />
                    <circle
                      cx="40" cy="40" r="34"
                ...
                <p className="text-xs font-mono" style={{ color: "var(--text-muted)" }}>Auto-retrying in {countdown}s...</p>
              </div>
            )}
